...
},{}],"ingredientsCRU.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addIngredient = void 0;
...
var addIngredient = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, calories, measure, soldIndividualy) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                ...
                calories: calories,
                measure: measure,
                soldIndividualy: soldIndividualy
              }
            });
          case 3:
            res = _context.sent;
          ...
          case 7:
            ...
            if (_context.t0.response.data.message.includes('duplicate key error')) {
              (0, _alerts.showAlert)('error', 'Recipe name is already existing');
            }
          case 10:
          case "end":
  ...
  return function addIngredient(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
exports.addIngredient = addIngredient;
},{"axios":"../../../../../../node_modules/axios/index.js","./alerts":"alerts.js"}],"recipesCRU.js":[function(require,module,exports) {
"use strict";
...
var addRecipe = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, description, steps, link, ingredients) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function addRecipe(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
...
var _ingredientsCRU = require("./ingredientsCRU");
var _recipesCRU = require("./recipesCRU");
// DOM ELEMENTS
var ingredientForm = document.querySelector('.form-ingredient-data');
var recipeForm = document.querySelector('.form-recipe-data');
var addMultipleBtn = document.querySelector('#more__ingredients');
if (ingredientForm) {
  ingredientForm.addEventListener('submit', function (event) {
    event.preventDefault();
    var name = document.getElementById('name').value;
    var calories = parseInt(document.getElementById('calories').value);
    var measure = document.getElementById('measure').value.toUpperCase();
    var soldIndividualy = document.getElementById('soldIndividualy').value == 'true' ? true : false;
    (0, _ingredientsCRU.addIngredient)(name, calories, measure, soldIndividualy);
  });
}
if (addMultipleBtn) {
  addMultipleBtn.addEventListener('click', function (event) {
    var elem = document.querySelector('#table__ingredient');
    var markup = elem.cloneNode(true);
    markup.style = 'margin-top:1rem';
    markup.value = 0;
    var btn = document.querySelector('.one__more__btn');
    btn.before(markup);
  });
}
if (recipeForm) {
